# Quirality of the triangle changed in relation to try1.py
...
p=f.Pattern(s,f.PermutationPattern((3,1,2)),42) # <<----------
p.synthesizeSonicVectors()

io=f.IOUtils()
io.recordPattern("som.wav",p)

#print "== Ouca que 'o triangulo gira com outra quiralidade e existe uma bola do lado' (nome da peca) =="