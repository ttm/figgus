...
sounda=doCompass(dur,"200*("+semitom+")**(3*i)",(3,1,2),6)
soundb=doCompass(dur,"200*("+semitom+")**(3*i)",(2,3,1),6)
sound = sounda+soundb

sounda1=doCompass(dur,"100*("+semitom+")**(3*i)",(3,1,2),6)
soundb1=doCompass(dur,"200*(2/3.)*("+semitom+")**(3*i)",(2,3,1),6)
