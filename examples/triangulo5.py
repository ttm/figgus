...
def doCompass(durs,freqs,perms,ncomps,ss):
    for i in xrange(n):
...
sounda=doCompass(dur,"200*("+semitom+")**(4*i)",(2,3,1),3)

s=f.Sequence(grains[1],grains[0],grains[2])
soundb=doCompass(dur,"200*("+semitom+")**(4*i)",(2,3,1),3)
