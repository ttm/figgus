...
left=[(i+j+k)*.32 for i,j,k in zip(sound1,sound2B,sound1C,)]; left1=left[:]
right=[(i+j+k)*.32 for i,j,k in zip(sound2,sound1B,sound2C)]; right1=right[:]
left += right1# [(i*j*k)*.32 for i,j,k in zip(sound2,sound1B,sound2C)]
right += left1#[(i*j*k)*.32 for i,j,k in zip(sound1,sound2B,sound1C)]
...
left3=[(i+j+k)*.32 for i,j,k in zip(sound2,sound2B,sound2C)]; left+=left3
right3=[(i+j+k)*.32 for i,j,k in zip(sound2,sound2B,sound1C)]; right+=right3
left+=right3
right+=left3
