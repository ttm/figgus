...
#sound1=2*doCompass(dur,"200*("+semitom+")**(3*i)",(2,3,1),3)
#sound1+=2*doCompass(dur,"200*("+semitom+")**(3*i)",(3,1,2),3)
#sound2=2*doCompass(dur,"4*200*("+semitom+")**(3*i)",(2,3,1),3)
#sound2+=2*doCompass(dur,"4*200*("+semitom+")**(3*i)",(2,3,1),3)
dur=".2"
sound=[]
sound+=2*doCompass(dur,"200*("+semitom+")**(3*i)",(2,3,1),3)

#sound2+=doCompass(dur,"0",(2,3,1),3)
...
#sound2+=doCompass(dur,"0",(2,3,1),2)

sound2=doCompass(dur,".4*200*("+semitom+")**(3*i)",(2,3,1),1)
sound2+=doCompass(dur,"100*("+semitom+")**(3*i)",(2,3,1),1)
#sound2+=doCompass(dur,"0",(2,3,1),1)
#sound2+=doCompass(dur,".4*200*("+semitom+")**(3*i)",(2,3,1),1)
#sound2+=doCompass(dur,"200*("+semitom+")**(3*i)",(2,3,1),1)
#sound2+=doCompass(dur,".4*200*("+semitom+")**(3*i)",(2,3,1),1)
#sound2+=doCompass(dur,"200*("+semitom+")**(3*i)",(2,3,1),1)
